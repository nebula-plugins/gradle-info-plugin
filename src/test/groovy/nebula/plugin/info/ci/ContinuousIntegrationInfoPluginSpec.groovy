...
class ContinuousIntegrationInfoPluginSpec extends IntegrationSpec {
    ...
    def "Populates manifest attributes by continuous integration info plugin - #provider"() {
        ...
        'Gitlab'         | [GITLAB_CI: 'true', CI_BUILD_NAME: 'org/my-repo', CI_BUILD_ID: '1', 'Build-Job': 'org/my-repo', 'CI_JOB_URL': 'http://localhost/org/my-repo/1']                                                                            || ['Build-Job': 'org/my-repo', 'Build-Number': '1', 'Build-Id': '1', 'Build-Url': 'http://localhost/org/my-repo/1']
        ...
        'Travis'         | [TRAVIS: 'true', TRAVIS_REPO_SLUG: 'org/my-repo', TRAVIS_BUILD_NUMBER: '10', TRAVIS_BUILD_ID: '1', 'Build-Job': 'org/my-repo', 'TRAVIS_BUILD_WEB_URL': 'http://localhost/org/my-repo/1']                                   || ['Build-Job': 'org/my-repo', 'Build-Number': '10', 'Build-Id': '1', 'Build-Url': 'http://localhost/org/my-repo/1']
        'Github Actions' | [CI: 'true', GITHUB_ACTION: 'my-action', GITHUB_REPOSITORY: 'org/my-repo', GITHUB_RUN_NUMBER: '10', GITHUB_RUN_ID: '1', 'GITHUB_SERVER_URL': 'http://some-github']                                                         || ['Build-Job': 'my-action', 'Build-Number': '10', 'Build-Id': '1', 'Build-Url': 'http://some-github/org/my-repo/actions/runs/10']
    }
