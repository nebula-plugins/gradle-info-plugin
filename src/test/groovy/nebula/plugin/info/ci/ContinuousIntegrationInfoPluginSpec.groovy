...
class ContinuousIntegrationInfoPluginSpec extends IntegrationSpec {
    ...
    def "Populates manifest attributes by continuous integration info plugin - #provider"() {
        ...
        'Titus'   | [TITUS_JOB_ID: 'cf12af48-e347-11ea-87d0-0242ac130003', TITUS_TASK_ID: 'dbac27de-e347-11ea-87d0-0242ac130003', NETFLIX_INSTANCE_ID: 'my-netflix-instance-id', NETFLIX_APP: 'my-netflix-app'] || ['Build-Job': 'my-netflix-app', 'Build-Number': 'cf12af48-e347-11ea-87d0-0242ac130003', 'Build-Id': 'cf12af48-e347-11ea-87d0-0242ac130003']
        'Drone'   | [DRONE: 'true', DRONE_REPO: 'org/my-repo', DRONE_BUILD_NUMBER: '1']                                                                                                                         || ['Build-Job': 'org/my-repo', 'Build-Number': '1', 'Build-Id': '1']
