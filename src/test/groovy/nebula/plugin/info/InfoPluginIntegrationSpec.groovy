...
class InfoPluginIntegrationSpec extends IntegrationSpec {
    ...
    def 'it returns build reports at the end of multiproject build - with buildscript classpath info - submodule has classpath'() {
        ...
        then:
        result.standardOutput.contains('{buildscript-multimodule-test-dependencies={Resolved-Buildscript-Dependencies-Classpath=com.google.guava:guava:21.0}, app-dependencies={Resolved-Buildscript-Dependencies-Classpath=com.github.jengelman.gradle.plugins:shadow:5.2.0,commons-io:commons-io:2.6,org.apache.ant:ant:1.9.7,org.apache.ant:ant-launcher:1.9.7,org.apache.logging.log4j:log4j-api:2.11.0,org.apache.logging.log4j:log4j-core:2.11.0,org.codehaus.plexus:plexus-utils:3.0.24,org.jdom:jdom2:2.0.6,org.ow2.asm:asm:7.0-beta,org.ow2.asm:asm-analysis:7.0-beta,org.ow2.asm:asm-commons:7.0-beta,org.ow2.asm:asm-tree:7.0-beta,org.vafer:jdependency:2.1.1, Resolved-Dependencies-CompileClasspath=com.google.guava:guava:19.0}, common-dependencies={Resolved-Dependencies-CompileClasspath=com.google.guava:guava:18.0}}')
    }
    ...
    def 'works with jenkins jpi plugin'() {
        ...
        buildFile << """
            buildscript {
              ...
              dependencies {
                classpath "org.jenkins-ci.tools:gradle-jpi-plugin:0.39.0-rc.3"
              }
            }
